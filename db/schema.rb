...
ActiveRecord::Schema.define(version: 20151022144525) do
  ...
  add_index "subscriptions", ["recipe_id", "user_id"], name: "index_subscriptions_on_recipe_id_and_user_id", unique: true, using: :btree
